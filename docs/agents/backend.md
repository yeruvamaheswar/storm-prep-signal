...
| `server/api/snapshot.py` | `GET /v1/snapshot` TickView and `GET /v1/runs/latest`. Live reads `/v1/feeds`. Demo/Synthetic reads the archive at the tape clock. |
