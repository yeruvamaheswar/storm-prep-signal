# ReserveGate: team manifest (Uma, Rajath, Sunny)
...
- **Rajath:** the controller and fleet, meaning how work is split across homes, what happens when homes fail, and scoring.
