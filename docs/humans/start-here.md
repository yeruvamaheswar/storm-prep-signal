...
Deadlines and the full list of what we will not drop are in `docs/agents/team-manifest.md`.

Long notes for the coding assistant live in `docs/agents`. Pages in this folder stay this short. When a decision should last, the assistant writes the long note there and a short page here if you need to read it.
